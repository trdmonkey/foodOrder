...
<head>
    ...
    <title>Log In • Restaurant One</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="" method="POST">
            ...
            <div class="text-center" style="color: red; margin: 2%; font-weight: bold;">
                <?php
            ...
            <div class="form-floating">
                <input type="text" name="username" class="form-control" id="floatingInput" placeholder="Ingrese el usuario">
                <label for="floatingInput">Usuario</label>
            </div>
            <div class="form-floating">
                <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="Ingrese la contraseña">
            ...
            <p class="mt-5 mb-3 text-body-secondary text-center" style="font-size: 0.8rem;">
                &copy; Creado por • <a href="http://jorge-luis.netlify.app/" target="_blank" style="text-decoration: none;">trdmonkey</a> •
            </p>
        </form>
    </main>
